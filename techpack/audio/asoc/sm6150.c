...
struct msm_asoc_mach_data {
	...
	struct device_node *sec_mi2s_gpio_p; /* used by pinctrl API*//*bug 431523,zhanghao1,20190301,add for audio bringup*/
...
static int msm_mi2s_snd_startup(struct snd_pcm_substream *substream)
{
	...
	if (++mi2s_intf_conf[index].ref_cnt == 1) {
		...
		/*bug 431523,zhanghao1,20190301,add for audio bringup*/
		if (index == SEC_MI2S)
...
#ifdef CONFIG_SND_SOC_MAX98937/*bug 431523,zhanghao1,20190301,add for audio bringup*/
	{
