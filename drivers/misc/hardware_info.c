...
char Lcm_name[HARDWARE_MAX_ITEM_LONGTH]={0};
char Sar_name[HARDWARE_MAX_ITEM_LONGTH]={0};
char board_id[HARDWARE_MAX_ITEM_LONGTH]={0};
...
static long hardwareinfo_ioctl(struct file *file, unsigned int cmd,unsigned long arg)
{
	...
	case HARDWARE_WIDE_ANGLE_CAM_EFUSEID_GET:
		hardwareinfo_num = HARDWARE_WIDE_ANGLE_CAM_EFUSEID;
		break;
